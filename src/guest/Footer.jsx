        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-blue-100 leading-relaxed">
              ...
              rekam medis secara aman dan praktis. Solusi terdepan untuk
              kemudahan akses informasi kesehatan Anda.
            </p>
            <p className="text-blue-100 leading-relaxed">
              Dengan teknologi terkini, kami memastikan keamanan dan privasi
              data medis Anda terjaga dengan baik.
            </p>
