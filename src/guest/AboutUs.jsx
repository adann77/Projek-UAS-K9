            ...
            <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
              ...
              <div className="space-y-4 sm:space-y-6 text-gray-600 leading-relaxed">
                <p className="text-sm sm:text-base lg:text-lg">
                  <strong className="text-gray-800">Sejarah Kami:</strong>{" "}
                ...
                <p className="text-sm sm:text-base lg:text-lg">
                  <strong className="text-gray-800">Visi Kami:</strong> Menjadi
                  penyedia layanan kesehatan terdepan yang memberikan perawatan
                  komprehensif, inovatif, dan berstandar internasional untuk
                  meningkatkan kualitas hidup masyarakat.
                </p>
                <p className="text-sm sm:text-base lg:text-lg">
                  <strong className="text-gray-800">Misi Kami:</strong>{" "}
                ...
                <div className="text-center">
                  ...
                  <div className="flex justify-center mt-1">
                    {[...Array(5)].map((_, i) => (
                      <svg
                        key={i}
                        className="w-2 h-2 sm:w-2.5 sm:h-2.5 lg:w-3 lg:h-3 text-yellow-400 fill-current"
                        viewBox="0 0 20 20"
                      >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
            {teamData.team.map((member, index) => (
              <div
                key={member.id}
                className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden hover:transform hover:scale-105"
              >
