...
const Reviews = () => {
  ...
  const getRoleIcon = (role) => {
    ...
    if (role.includes("Perawat"))
      return <Heart className="w-5 h-5 text-red-500" />;
    if (role.includes("Apoteker"))
  ...
  const totalReviews = testimonials.length * 15;
  const averageRating = (
    ...
    <div className="bg-white min-h-screen font-sans text-gray-800">
      <header className="flex justify-between items-center px-8 py-4 bg-white shadow-md sticky top-0 z-50">
        ...
        <nav className="space-x-6 font-medium text-gray-700 hidden md:flex">
          <Link
            to="/guest"
            className="hover:text-blue-600 transition-colors transform hover:scale-105 duration-300"
          >
            Home
          </Link>
          <Link
          ...
          <Link
            to="/reviews"
            className="text-blue-600 font-semibold transform hover:scale-105 transition-transform duration-300"
          >
            Reviews
          </Link>
        </nav>
        <div className="space-x-3">
          ...
          <Link
            to="/register"
            className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 shadow-md transition-transform duration-300 transform hover:scale-105"
          >
            Sign up
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Apa Kata <span className="text-blue-600"> Tenaga Medis </span>{" "}
              Tentang Kami
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Dipercaya oleh ribuan profesional kesehatan di seluruh Indonesia
              untuk mengelola rekam medis dengan aman, efisien, dan
              terintegrasi.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-1 transform transition-all duration-300">
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                <div className="flex justify-between items-center mb-6">
                  <button
                    ...
                    className="p-2 rounded-full border border-gray-300 hover:bg-gray-100 transition-all duration-300 transform hover:scale-110"
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-green-500 rounded-full flex items-center justify-center text-white font-bold text-xl transform transition-transform duration-300 hover:rotate-3 hover:scale-105">
                    {currentReview.name
                      .split(" ")
                      .map((n) => n[0])
                      .join("")}
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="p-6 bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transform hover:scale-105 transition duration-300">
